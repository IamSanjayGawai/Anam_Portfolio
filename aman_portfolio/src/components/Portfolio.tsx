...
<div className="grid grid-cols-1 md:grid-cols-3 gap-4">
  ...
  <ProjectCard key={p.title} project={p} index={0} />
))}
...
// type Project = {
//   _id: string;
//   type: "recent" | "case" | "open" | "published";
//   title: string;
...
//     "recent" | "case" | "open" | "published"
//   >("recent");
//   const [modalProject, setModalProject] = useState<
//     Project | ExploreProject | null
//   >(null);
//   const [isModalVisible, setIsModalVisible] = useState(false);
//   const [projects, setProjects] = useState<Project[]>([]);

//   // ✅ backend URL should be the API, not Mongo URI
...
//     <div
//       key={index}
//       className="bg-black rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 w-full  group flex flex-col transform hover:-translate-y-1"
//     >
//       <div className="overflow-hidden rounded-t-xl">
//         <img
//           src={
...
//             <span
//               key={tech}
//               className={`${project.techClasses[i]} px-2 py-1 rounded text-xs font-semibold`}
//             >
//               {tech}
//             </span>
//           ))}
...
//   // ✅ Component: ExploreProjectCard
//   const ExploreProjectCard: React.FC<{ project: ExploreProject }> = ({
//     project,
//   }) => (
//     <div className="bg-[#10111A] rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 flex flex-col group h-full transform hover:-translate-y-1">
//       <img
...
//           ))}
//         </div>
//         <p className="text-gray-400 mb-4 flex-1">{project.desc}</p>
//         <div className="flex gap-2 mt-auto">
//           {project.live && (
//             <a
//               href={project.live}
...
//               <span
//                 key={tech}
//                 className={`inline-block ${modalProject.techClasses[i]} px-2 py-1 rounded text-xs font-semibold mr-2 mb-2`}
//               >
//                 {tech}
//               </span>
//             ))}
...
//             <ProjectCard key={p._id || index} project={p} index={index} />
//           ))}
//         </div>
...
//               .filter((project) => project.type === activeTab)
//               .map((project, index) => {
//                 const image = project.imagePreview
//                   ? project.imagePreview
//                   : project.imageUrl?.startsWith("http")
//                   ? project.imageUrl
//                   : project.imageUrl
...
//                 return (
//                   <ExploreProjectCard
//                     key={`${activeTab}-${project._id || index}`}
